...
def buscar_por_id(numero):
   for pokemon in pokedex:
      if pokemon["id"] == numero:
            return render_template("pokemon.html", pokemons=[pokemon])
         
# Ruta para mostrar una cantidad específica de Pokémon
@app.route("/limite/<int:cantidad>")
def pokemon_limite(cantidad):
   return render_template("pokemon.html", pokemons=pokedex[:cantidad])
